...
<head>
    @if ($email_origin === 'consultora')
        <title>Contacto desde Consultora</title>
    @else
        <title>Contacto desde Porfolio</title>
    @endif
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="{{ env('APP_URL') }}"
                                ...
                                @if ($email_origin === 'consultora')
                                    <img src="{{ asset('img/home/dp_logo.png') }}" class="logo" alt="Logo MdP"
                                ...
                                @else
                                    <img src="{{ asset('img/porfolio/avatar.svg') }}" class="logo" alt="Logo MdP"
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 75px; max-height: 75px; width: 75px;">
                                @endif
                            </a>
                        </td>
                                    ...
                                    <td class="content-cell"
                                        ...
                                        @if ($email_origin === 'consultora')
                                            <p
                                                ...
                                                El Sr/Sra: <strong>{{ $nombre }}</strong> te envio un mensaje
                                                desde tu web-consultora.
                                                Puedes contactarlo a: <strong>{{ $email }}</strong></p>
                                        @else
                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                El Sr/Sra: <strong>{{ $nombre }}</strong> te envio un mensaje
                                                desde tu
                                                portfolio. Puedes contactarlo a: <strong>{{ $email }}</strong>
                                            </p>
                                        @endif
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            &copy; {{ date('Y') }} {{ env('APP_NAME') }}. Todos los derechos
                                            reservados.</p>
                                    </td>
                                </tr>
                            </table>
