...
@section('headers')
    <link rel="preload" href="{{ asset('img/home/bg_hosting.svg') }}" as="image">
@endsection
        ...
        <div class="home-fuentes__grid">
            <div class="home-fuentes__principal">
                <div class="home-fuentes__text">
                    ...
                    <p class="home-fuentes__sub">{{ __('home_text.host_sub') }}</p>
                    <p class="home-fuentes__desc">{{ __('home_text.host_desc0') }}</p>
                    <p class="home-fuentes__desc">{{ __('home_text.host_desc1') }}</p>
                    <p class="home-fuentes__desc">{!! __('home_text.host_desc2') !!}</p>
                </div>
            </div>
