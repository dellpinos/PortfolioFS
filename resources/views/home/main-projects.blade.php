            ...
            <div class="main-projects__card main-projects__tl" data-aos="flip-left">
                <div class="main-projects__contenedor-heading">
                    ...
                    <div class="main-projects__iconos">
                        ...
                        {{-- <i class="main-projects__icono--oculto c-azul fa-solid fa-database"></i> --}}
                        <svg class="main-projects__icono--oculto" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-mysql" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.5" stroke="#0284C7" fill="none" stroke-linecap="round" stroke-linejoin="round">
