<div class="perfil__contenedor">
    ...
    <div class="perfil__contenedor-desc">
        ...
        <div class="perfil__contenedor-img">
            ...
            <picture>
                <source srcset="img/porfolio/perfil.avif" type="image/avif">
                <source srcset="img/porfolio/perfil.webp" type="image/webp">
                <img loading="lazy" width="400" height="600" src="img/porfolio/perfil.png" alt="Imagen Perfil">
            </picture>
