<div class="new-dev-projects__contenedor-xl" id="proyectos-personales-contenedor">
    ...
    <div class="new-dev-projects__contenedor"> {{--  Contenedor de proyectos  --}}
        ...
        <div class="new-dev-projects__contenedor-prin" id="dev-projects-slide-ta">
            ...
            <div class="new-dev-projects__card new-dev-projects__ticket new-dev-projects__contenedor-box">
                <div class="new-dev-projects__contenedor-heading">
                    <h3 class="new-dev-projects__heading-ta">TicketAdmin</h3>

                    <div class="new-dev-projects__iconos">
                        <svg class="new-dev-projects__icono--oculto" xmlns="http://www.w3.org/2000/svg" width="40"
                            height="40" viewBox="0 0 24 24" stroke-width="1.5" stroke="#0284C7" fill="none"
                        ...
                        <i class="new-dev-projects__icono--oculto c-rojo fa-brands fa-laravel"></i>
                        <i class="new-dev-projects__icono--oculto c-ama fa-brands fa-square-js"></i>
                        <i class="new-dev-projects__icono--oculto c-rosa fa-brands fa-sass"></i>
                        <a href="https://github.com/dellpinos" target="_blank">
                            <i class="new-dev-projects__icono fa-brands fa-github"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="new-dev-projects__text">
                    ...
                    <div class="tour__contenedor-card">
                        <div class="tour__card-ticket" id="tour-card-ticket">
                            ...
                            <img src="{{ asset('img/porfolio/page.svg') }}" class="tour__card-logo-ta" alt="Logo Ticket Admin"
                                loading="lazy">
        ...
        {{-- TusListas --}}
        <div class="new-dev-projects__contenedor-prin new-dev-projects__contenedor-prin--der"
            id="dev-projects-slide-tl">

            <div class="new-dev-projects__card new-dev-projects__tl new-dev-projects__contenedor-box">
                <div class="new-dev-projects__contenedor-heading">

                    <div class="new-dev-projects__contenedor-img">
                        <img loading="lazy" src="img/porfolio/logoTL_2.png" alt="Logo Tus Listas" width="200" height="70">
                    </div>

                    <div class="new-dev-projects__iconos">
                        <svg class="new-dev-projects__icono--oculto" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="new-dev-projects__text">
                    ...
                    <div class="tour__contenedor-card">
                        <div class="tour__card" id="tour-card-tuslistas">
                            ...
                            <img src="{{ asset('img/porfolio/LogoSinFondo.png') }}" class="tour__card-logo" alt="Logo Tus Listas"
                                loading="lazy">
                            <div class="tour__card-contenedor-text">
        ...
        {{-- Stuff --}}
        <div class="new-dev-projects__contenedor-prin" id="dev-projects-slide-st">

            <div class="new-dev-projects__card new-dev-projects__stuff new-dev-projects__contenedor-box">
                <div class="new-dev-projects__contenedor-heading">
                    <h3 class="new-dev-projects__heading-st ">Stuff</h3>
        ...
        {{-- Bakery Store --}}
        <div class="new-dev-projects__contenedor-prin new-dev-projects__contenedor-prin--der" id="dev-projects-slide-bs">

            <div class="new-dev-projects__card new-dev-projects__ticket new-dev-projects__contenedor-box">
                <div class="new-dev-projects__contenedor-heading">
                    <h3 class="new-dev-projects__heading-bs">BakeryStore</h3>

                    <div class="new-dev-projects__iconos">

                        <svg class="new-dev-projects__icono--oculto" viewBox="-4 0 264 264" xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                        ...
                        <svg class="new-dev-projects__icono--oculto" xmlns="http://www.w3.org/2000/svg"
                            aria-label="Django Project" role="img" width="40" height="40"
                            viewBox="0 0 512 512" fill="#000000">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <rect width="512" height="512" rx="15%" fill="#0b4a32"></rect>
                                <path fill="#ffffff"
                        ...
                        <i class="new-dev-projects__icono--oculto c-ama fa-brands fa-square-js"></i>
                        <i class="new-dev-projects__icono--oculto c-azul fa-brands fa-css3"></i>
                        <a href="https://github.com/dellpinos" target="_blank">
                            <i class="new-dev-projects__icono fa-brands fa-github"></i>
                        </a>
                    </div>
                ...
                <div class="new-dev-projects__text">
                    ...
                    <div class="tour__contenedor-card">
                        <div class="tour__card-ticket" id="tour-card-store">
                            <i id="tour-play-icon-store" class="tour__play fa-solid fa-circle-play"></i>

                            <img src="{{ asset('img/porfolio/cupcake_bs.svg') }}" class="tour__card-logo-ta"
