...
export default function galeria() {
    ...
    function crearGaleria() {
        ...
        imgVisibles.forEach(element => {
            ...
            webP.setAttribute('srcset', `img/porfolio/thumb/${element}_thumb.webp`);
            webP.setAttribute('type', 'image/webp');

            const avif = document.createElement('SOURCE');
            avif.setAttribute('srcset', `img/porfolio/thumb/${element}_thumb.avif`);
            ...
            img.setAttribute("src", `img/porfolio/thumb/${element}_thumb.jpg`);
    ...
    function cargarImagenes(array, swiperSecundario, nav, overlay) {
        ...
        for (let i = 0; i < imgs.length; i++) {
            ...
            imagen.innerHTML = `
                    <source srcset="img/porfolio/grande/${imgs[i]}.avif" type="image/avif">
                    <source srcset="img/porfolio/grande/${imgs[i]}.webp" type="image/webp">
                    <img loading="lazy" src="img/porfolio/grande/${imgs[i]}.jpg" alt="Imagen Galeria">
